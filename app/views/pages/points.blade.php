...
<div class ="container">
	...
	<ul class="expanders">
		...
		<li>
			<a href="#" class="expanders__relay relayexp1"
				...
				<input  type="hidden" value="Jarząb pospolity z rodziny różowatych, zwany po prostu jarzębiną, to drzewo lub krzew dorastający nawet do 15 metrów wysokości. Kwitnie od maja do czerwca - kwiaty wydzielają przy tym charakterystyczny migdałowy aromat. Owoce jarzębiny są pożywieniem ptaków oraz zwierząt leśnych, jednak dla człowieka na surowo są niejadalne, nie tylko z powodu gorzkiego smaku, ale również przez zawartość trującego składnika. Po przemrożeniu lub wyparzeniu tracą gorycz oraz trujące właściwości i mogą być użyte do przetworów - są wartościowe, gdyż zawierają dwukrotnie więcej karotenu niż marchew.
	...
	<ul class="expanders">
		...
		<li>
			<a href="#" class="expanders__relay hidden-element  relayexp1"
		...
		<ul class="expanders">
			<li>
				<a href="#" class="expanders__relay rasp__defaults rasp-custom-button relayexp1"
				   audio="lasjesienny.mp3"
				   relayId="relay8"
				   expander=""
				   pin="1">Las Jesienny </a>
				<input  type="hidden" value="

				Ostatnią fazą rozwoju lasu, po okresie dojrzewania i dojrzałości drzewostanu, jest starodrzew – są to drzewa zwykle powyżej stu lat zbliżające się do kresu życia. Las taki przestaje przyrastać, a pojedyncze drzewa zaczynają już zamierać, ustępując miejsca nowym pokoleniom i innym gatunkom - zwłaszcza w przypadku lasu mieszanego. Dzięki większemu niż w przypadku młodszych drzewostanów dostępowi światła rozwija się bujna, różnorodna flora. Pojawiają się też licznie grzyby, w lesie mieszanym można znaleźć rozmaite ich gatunki. Taki las zamieszkuje wiele zwierząt - stare drzewa dostarczają im pokarmu, kryjówek, miejsc do zakładania legowisk i gniazd. Jesienią gryzonie i niektóre ptaki nie mają większego problemu ze znalezieniem tutaj schowków do magazynowania pożywienia na zimę a i większe ssaki mogą znaleźć kryjówki, w których będą mogły zapaść w spokojny sen zimowy. Nawet obumarłe, martwe drzewo jest ważnym siedliskiem niedostrzeganego na pierwszy rzut oka życia - znaleźć w nim możemy miliony zamieszkujących je organizmów. 
" class="text-to-append dispNone" />
			</li>
		</ul>
