...
//All pins actions
    ...
    {
	$this->allExp('/usr/sbin/i2cset -y 1 0x21 0x00 0x00')->run();
	$this->allExp('/usr/sbin/i2cset -y 1 0x21 0x01 0x00')->run();
    ...
    {
	$this->allExp('/usr/sbin/i2cset -y 1 0x21 0x00 0xff')->run();
	$this->allExp('/usr/sbin/i2cset -y 1 0x21 0x01 0xff')->run();
