...
//All pins actions
	...
	$this->allExp('curl 192.168.0.72/index.php/swon')->run();
    }
	...
	$this->allExp('curl 192.168.0.72/index.php/swoff')->run();
    }
...
//    Updater - its only pull from origin.
    ...
    public function _sendDataToExternal()
    {
        $data = Input::all();
        $client = new Client();
        $res = $client->request('GET', 'http://192.168.0.72/index.php/recive', [
            'form_params' => $data
        ]);
        $result = $res->getBody();
